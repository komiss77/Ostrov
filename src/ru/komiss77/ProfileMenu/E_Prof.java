...
public enum E_Prof {
    ...
    СТАТИСТИКА(45,"§eСтатистика", "§aЛКМ §7- Ваша статистика<br>§aПКМ §7- Ваши достижения<br>§aShift+Клик §7- Ваш журнал Островитянина<br><br>§b/passport get §7- получить паспорт<br>Чтобы посмотреть<br>Паспорт другого игрока,<br>наберите §b/passport see ник<br>или правый клик на игрока<br>с паспортом в руке.<br>Редактировать свой паспорт-<br>раздел §eнастройки", "a683dae6d132f52efa55e98c181def5403672fdec2cbcf4793142cb0e59bd0", Material.RED_STAINED_GLASS_PANE),
    ЗАДАНИЯ(46,"§bЗадания", "", "cf40942f364f6cbceffcf1151796410286a48b1aeba77243e218026c09cd1", Material.ORANGE_STAINED_GLASS_PANE), 
    ДРУЗЬЯ(47,"§aДрузья", "§aЛКМ §7- друзья<br>§aПКМ §7- настройки друзей<br>§cShift+Клик §7- режим удаления друзей<br><br>Добавить друга-клик головой<br>или команда §6/fr add ник", "3228db8b2cd49a4b986a3b0ea8a161a1742b1c07fd0e2b15be88dc76498e5", Material.PURPLE_STAINED_GLASS_PANE), 
    КОМАНДА(48,"§5Команда", "§aЛКМ §7- участники<br>§aПКМ §7- настройки команды<br>§cShift+Клик §7- режим удаления участников<br><br>Создать команду-§6/party create", "2c2be3bc607773264ceee0edd615316341ec2b465a16cdb578bdaedd643d", Material.GREEN_STAINED_GLASS_PANE), 
    ДОНАТ(49,"§3Купить привилегии", "§aЛКМ §7- посмотреть привилегии<br>§aПКМ §7- пополнить счёт<br><br>§fНа сервере у Вас есть<br>§fрублёвый счёт (§eрил§f).<br>§fВы можете пополнять его<br>§fчерез платёжную систему,<br>§fи использовать эти средства<br>§fдля покупки привилегий, обмена<br>§fна игровую валюту (§eлони§f)<br>§fи прочее.", "d295a929236c1779eab8f57257a86071498a4870196941f4bfe1951e8c6ee21a", Material.CYAN_STAINED_GLASS_PANE), 
    СЕРВЕР(50,"§fВыбор сервера§7/§aPiPBoy", "§fЛКМ §7- Открыть меню выбора<br>§aПКМ §7-Открыть локальное меню", "362a1b473ba3c25e6eb1458dfc953921f5d91478af9d6dda07c032f928c", Material.BLACK_STAINED_GLASS_PANE), 
    ПОМОЩЬ(51,"§2Помощь","§aЛКМ §7- по глобальным командам<br>§aПКМ §7- локальные команды<br>§aShift+клик §7- Администрация<br><br>Глобальные команды действуют<br>на всех серверах,<br>Локальные - выполняются только<br>на том сервере, где вы<br>находитесь в данный момент.", "fed4ae757f23445b5c9335cc5a8f7f7c6f9a5aee85bb69fe97f581dafb18d30", Material.BROWN_STAINED_GLASS_PANE), 
    НАСТРОЙКИ(52,"§6Локальные настройки", "§aЛКМ §7- Настройки для текущего сервера<br>§aПКМ §7- редактировать пасспорт Островитянина", "b86b9d58bcd1a555f93e7d8659159cfd25b8dd6e9bce1e973822824291862", Material.BLACK_STAINED_GLASS_PANE), 
    ...
    private E_Prof(int slot, String item_name, String lore, String texture, Material mat){
        this.slot = slot;
    ...
    public static boolean isProfileIcon(final int slot){
        for(E_Prof s_: E_Prof.values()){
            if (s_.slot==slot) return true;
        }
        return false;
    }
    
    public static E_Prof profileBySlot(final int slot){
        for(E_Prof s_: E_Prof.values()){
    ...
    public static ItemStack getItem(final E_Prof profile){
//System.out.println("++++++++++++++++++++++.E_Prof.getItem()");
        ...
        return VM.getNmsServer().getCustomHead(profile.texture, profile.item_name, profile.lore);
