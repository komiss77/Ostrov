            ...
            switch (arg.length) {
                ...
                case 1:
                    if ( CMD.isNumber(arg[0]) ) {
                        ...
                        //final TreeSet<String,Integer> sorted=entriesSortedByValues(count);
                ...
                case 2:
                    if ( CMD.isNumber(arg[0]) ) {
                        ...
                        if (max_loc==null) {
                            ...
                            TextComponent msg = new TextComponent( "§eНаибольшее колл-во в чанке "+max_loc.getChunk().getX()+"*"+max_loc.getChunk().getZ()+", клик-ТП");
                            msg.setClickEvent(new ClickEvent(ClickEvent.Action.RUN_COMMAND, "/tp "+p.getName()+" "+max_loc.getBlockX()+" "+max_loc.getBlockY()+" "+max_loc.getBlockZ() ) );
