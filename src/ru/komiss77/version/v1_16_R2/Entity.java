...
public class Entity implements IEntity {
    ...
    @Override
    //public void Register(Class<? extends net.minecraft.server.v1_16_R2.Entity> entityClass, int id) {  //на основе holographic displays
    ...
    public Entity spawnNMSSlime(org.bukkit.World bukkitWorld, net.minecraft.server.v1_16_R2.Entity nmsEntity, double x, double y, double z) {
	...
	private boolean addEntityToWorld(WorldServer nmsWorld, net.minecraft.server.v1_16_R2.Entity nmsEntity) {
	//Validator.isTrue(Bukkit.isPrimaryThread(), "Async entity add");
            ...
            try {
                ReflectMethod<Void> REGISTER_ENTITY_METHOD = new ReflectMethod<>(WorldServer.class, "registerEntity", net.minecraft.server.v1_16_R2.Entity.class);
