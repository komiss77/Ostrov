...
public class Server implements IServer {
    ...
    @Override
    public ItemStack getCustomHead (String texture, final String item_name, final String lore){
        
        return new ItemBuilder(Material.PLAYER_HEAD)
                .name(item_name)
                .addLore(ItemUtils.Gen_lore(null, lore, ""))
    ...
    public void sendFakeEquip(final Player player, final int playerInventorySlot, final ItemStack itemStack) {
        final net.minecraft.server.v1_16_R2.EntityPlayer handle = ((CraftPlayer)player).getHandle();
...
//System.out.println("center="+center+" radius="+radius);        
    ...
    @Override
    public int getitemDespawnRate(final World bukkitWorld) {
