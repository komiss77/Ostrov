...
final class CustomAnvil {
  ...
  public Object jsonChatComponent(String json) {
    return Component.Serializer.fromJson(json, new HolderLookup.Provider() {
      @Override
  ...
  protected static class AnvilContainer extends AnvilMenu {
    ...
    public void setRenameText(String text) {
      ...
      if (inputLeft.isFake()) {
        inputLeft.set(net.minecraft.world.item.ItemStack.fromBukkitCopy(
          new ItemBuilder(inputLeft.getItem().asBukkitMirror()).name(text).build()));
      }
    }
