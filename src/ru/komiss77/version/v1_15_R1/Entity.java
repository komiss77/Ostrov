...
public class Entity implements IEntity {
    ...
    @Override
    //public void Register(Class<? extends net.minecraft.server.v1_15_R1.Entity> entityClass, int id) {  //на основе holographic displays
    ...
    public Entity spawnNMSSlime(org.bukkit.World bukkitWorld, net.minecraft.server.v1_15_R1.Entity nmsEntity, double x, double y, double z) {
	...
	//Validator.isTrue(Bukkit.isPrimaryThread(), "Async entity add");
            ...
            try {
                ReflectMethod<Void> REGISTER_ENTITY_METHOD = new ReflectMethod<>(WorldServer.class, "registerEntity", net.minecraft.server.v1_15_R1.Entity.class);
