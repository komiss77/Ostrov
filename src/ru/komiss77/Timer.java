...
public class Timer {
    ...
    private static int midnightStamp;
    ...
    public static void LoadVars() {
        ...
        midnightStamp = (int) (Ostrov.calendar.getTimeInMillis()/1000);
...
//System.out.println("delay_bossbar : " +delay_bossbars);
                   ...
                   // }
                    ...
                    Bukkit.getOnlinePlayers().stream().forEach( (p) -> {
                            PM.getOplayer(p).Tick_every_second(p);
                        }
                    );
            ...
            timerAsync =  new BukkitRunnable() {
                ...
                public void run() {
                    ...
                    if (counter%10==0 && PM.hasOplayers()) {
                        ApiOstrov.sendMessage(Operation.GET_ONLINE);
                    }
                    
                    Informator.tick();
                    
                    GM.tickAsync(counter);
...
/*
    ...
    public static int leftBeforeResetDayly() {
        return midnightStamp - currentTime;
    }
