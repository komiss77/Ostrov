...
public enum Stat {
    ...
    PLAY_TIME (300, Game.GLOBAL,  "§3Игровое время §7: ",  0, null ), //промежуточных сохранений нет, только при выходе (расчёт на входе+текущая сессия)
    EXP (301, Game.GLOBAL,  "§3Опыт §7: ",  0, null ),
    LEVEL (302, Game.GLOBAL,  "§3Уровень островитянина §7: ",  0, null ),
    FLAGS (303, Game.GLOBAL,  "§3флаги §7: ",  0, null ),
