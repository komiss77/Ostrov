...
//System.out.println("+++++++++++++++++++Load() s="+s+"  limit="+Conf.spawn_limiter.getInt("mob_limiter.limits.blockstates."+s));
    ...
    public void loadConfig () {
        ...
        for (LimitType lt: LimitType.values()) {
            if (lt!=null) spawn_limiter.addDefault("mob_limiter.limits.blockstates."+lt.toString(), lt.limit);
        }
    ...
    public void onInteract(PlayerInteractEvent e) {
        ...
        if (e.getAction() == Action.RIGHT_CLICK_BLOCK
            ...
            if (Timer.has(p, "vehicle")) {
                ApiOstrov.sendActionBarDirect(p, "§eПодождите "+Timer.getLeft(p, "vehicle" )+" сек.!");
            }
...
/*
    ...
    private void CheckEntyty(final Chunk chunk) {
        ...
        int removed=0;
            ...
            for (Entity entity: chunk.getEntities()) {
                ...
                eGroup = VM.getNmsEntitygroup().getEntityType(entity);
    ...
    private boolean FastCheck(final Entity e, final SpawnReason reason) {
        ...
        final EntityGroup group = VM.getNmsEntitygroup().getEntityType(e);
...
/*
    ...
    public static enum LimitType { 
        ...
        public static LimitType getType(final Material mat) {
            ...
            if ( Tag.BANNERS.isTagged(mat)) return БАННЕРЫ;
