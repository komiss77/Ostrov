...
public enum Game {
    ...
    DA("§a❂ ", 1, 0, 3, "Daaria", "daaria",
        ...
        Arrays.asList("§оКлассическое выживание", "§она последней версии игры.", "§оТорговля, ивенты, приваты, и др.", "§eЗаходи и развивайся с друзьями!"),
        0, -99),
    SE("§4☠ ", 2, 0, 15, "Sedna", "sedna_wastes",
        ServerType.ONE_GAME, "CRIMSON_NYLIUM", "§4§lСедна",
        Arrays.asList("§cХардкорный режим с новыми", "§cскиллами, мирами, мобами,", "§cкрафтами, и постройками.", "§eУничтожай местную фауну!", "§4Не для новичков. §n[Бета Тест]"),
        0, -99),
    AR("§a☺ ", 3, 0, 11, "Arcaim", "arcaim",
        ServerType.ONE_GAME, "NETHERITE_PICKAXE", "§e§lАркаим", Arrays.asList("§бРежим с халявным креативом, где", "§бты можешь создать свой мир", "§би проявить творчество.", "§eИграй один или с друзьями!"),
        0, -99),
    MI("§5✠ ", 4, 0, 5, "Midgard", "midgard",
        ServerType.ONE_GAME, "SCULK_SHRIEKER", "§5§lМидгард", Arrays.asList("§лОкунись в мир клановых воин,", "§лсоздав свое поселение. Приглашай", "§лдрузей, прокачивай экипировку и", "§лресурсы, разнося всех на пути.", "§eВозведи империю с нуля!"),
        0, -99),
    @Deprecated // use SB
    SK("§f☯ ", 5, 0, 29, "SkyWorld", "skyworld",
        ServerType.ONE_GAME, "FLOWERING_AZALEA", "§b§lОстрова", Arrays.asList("§нНачни жизнь на крохотном", "§ностровке, добывай ресурсы,", "§ни выполняй задания.", "§eПройди все ветки заданий!"),
        0, -99),
    OB("§b◈ ", 6, 0, 39, "OneBlock", "oneblock",
        ServerType.ONE_GAME, "AZALEA", "§bOneBlock", Arrays.asList("§нПогрузись в выживание на", "§нодном блоке в пустоте,", "§нрасширяя границы за преодоление", "§нразличных фаз.", "§eПриумнож свои старания!"),
        0, -77),
    SD("§f✜ ", 7, 0, 0, "SkyGrid", "skygrid",
        ServerType.ONE_GAME, "SPAWNER", "§bSkyGrid", Arrays.asList("§нВыживи в брутальной сетке", "§нблоков, собери всё, чтобы", "§нпостроить собственный островок", "§ни пройти игру.", "§eПострой свой мир по кусочкам!"),
        0, -77),
    PA("§5❖ ", 8, 0, 33, "Parkour", "parkur",
        ServerType.ONE_GAME, "FEATHER", "§b§lПаркуры", Arrays.asList("§мОтточи свое мастерство паркура", "§мна нашем захватывающем режиме", "§мс 60+ различных карт.", "§eПокажи свое проворство!"),
        0, -77),
    EN("E", 7, 0, 41, "Enigma", "enigma",
        ServerType.ONE_GAME, "END_PORTAL_FRAME", "§d§lЭнигма", Arrays.asList("§иРежим тайн и загадок, где каждый", "§ицикл тебя ждут новые испытания.", "§eПрийми вызов фортуны!", "§к§n[В Разработке]"),
        0, -77),
    JL("§5☭ ", 10, 0, 0, "Jail", "jail",
        ServerType.ONE_GAME, "SOUL_LANTERN", "§ф§lЧистилище", Arrays.asList(""),
        0, -99),
    FA("§5🤓 ", 9, 0, 0, "Fatta", "fatta",
