...
public enum Settings {
    ...
    @Deprecated
    Fr_TeleportDeny(10, 100, "§eМаячёк", Arrays.asList("<mithril>Разрешить друзьям", "<mithril>отправлять Вам запросы", "<mithril>на телепорт?")),
    @Deprecated
    Fr_InviteDeny(11, 100, "§6Открытость", Arrays.asList("<mithril>Получать предложения дружить", "<mithril>от других игроков?")),

    @Deprecated
    Fr_ShowFriendDeny(12, 100, "§6Видеть друзей в лобби", Arrays.asList("")),
    @Deprecated
    Fr_ShowPartyDeny(13, 100, "§6Видеть команду в лобби", Arrays.asList("")),
    @Deprecated
    Fr_ShowOtherDeny(14, 100, "§6Видеть остальных в лобби", Arrays.asList("")),
    @Deprecated
    Party_LeaderTrackDeny(15, 100, "§eОтслеживать лидера", Arrays.asList("<mithril>Получать уведомления,", "<mithril>когда лидер меняет сервер?")),
    @Deprecated
    Party_LeaderFollowDeny(16, 100, "§eСледовать за лидером", Arrays.asList("<mithril>Телепортировать Вас к лидеру", "<mithril>когда он меняет сервер?", "<mithril>(полезно для командных игр)")),
    @Deprecated
    Party_InviteFriendsDeny(17, 100, "§eОткрытость друзьям", Arrays.asList("<mithril>Получать предложения", "<mithril>вступить в команду от друзей?")),
    @Deprecated
    Party_InviteOtherDeny(18, 100, "§eОткрытость остальным", Arrays.asList("<mithril>Получать предложения", "<mithril>вступить в команду от остальных?")),
    ...
    ShowOtherDeny(13, 100, "§6Видеть остальных в лобби", Arrays.asList("")),
    ...
    JustGame(19, 100, "§8Играть без квестов", Arrays.asList("<mithril>Играть без всяких квестов")),
    ;
