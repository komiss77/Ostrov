...
//System.out.println("nextLine 222 index="+index+" position="+position+"  current_line_lenght="+current_line_lenght );        
            ...
            if (!dm.isUnbreakable()) {
                ...
                if (dm.getDamage() + damage < it.getType().getMaxDurability()) {
                    ...
                    switch (breackEffect) {
                        ...
                        case BREAK_EQUIPMENT_CHESTPLATE ->
                            p.getInventory().setChestplate(air);
                        case BREAK_EQUIPMENT_LEGGINGS ->
                            p.getInventory().setLeggings(air);
                        case BREAK_EQUIPMENT_BOOTS ->
    ...
    @Deprecated
    public static String toStfring(final ItemStack is) { //ошибка в названии!
        return toString(is, ":");
    }
                ...
                switch (splittedParam[0].trim().toLowerCase()) {
                    ...
                    case "basepotiondata":
                        if (splittedParam.length == 4) {
                            ...
                            Ostrov.log_warn("Декодер basepot : §7строка >§f" + item + "§7<, неверные параметры §f" + splittedParam[1].toUpperCase());
                        }
                        break;
                    ...
                    case "custompotioneffect":
                        if (splittedParam.length == 4) {
                            switch (builder.getType()) {
                                ...
                                LINGERING_POTION, SPLASH_POTION:
                                    ...
                                    if (potionEffectType != null) {
                                        ...
                                        Ostrov.log_warn("Декодер effect : §7строка >§f" + item + "§7<, нет PotionType §f" + splittedParam[1].toUpperCase());
                                    }
                                    break;
                                default:
                            ...
                            Ostrov.log_warn("Декодер effect : §7строка >§f" + item + "§7<, неверные параметры §f" + splittedParam[1].toUpperCase());
                        }
                        break;
                    case "trim":
                        if (splittedParam.length == 3) {
                            ...
                            Ostrov.log_warn("Декодер trim : §7строка >§f" + item + "§7<, неверные параметры §f" + splittedParam[1].toUpperCase());
                        }
                        break;
                    case "firework":
                        if (splittedParam.length == 2) {
                            ...
                            Ostrov.log_warn("Декодер firework : §7строка >§f" + item + "§7<, неверные параметры §f" + splittedParam[1].toUpperCase());
                        }
                        break;
                    case "burst":
                        if (splittedParam.length == 6) {
                            ...
                            Ostrov.log_warn("Декодер burst : §7строка >§f" + item + "§7<, неверные параметры §f" + splittedParam[1].toUpperCase());
                        }
                        break;
                    default:
...
//System.out.println("getBiomeIcon "+b.toString());       
    ...
    public static ItemBuilder buildEntityIcon(final EntityType type) {
        ...
        builder.name(Lang.t(null, (Translatable) type));
        return builder;
    }
