...
public class Nbtfind implements CommandExecutor {

    //private Ostrov creativeGuard;

    public Nbtfind(Ostrov creativeGuard) {
    ...
    public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
        ...
        if ( (sender instanceof Player) && !ApiOstrov.hasGroup(sender.getName(), "moder" ) ) {
            ...
            if (material == null) {
                    ...
                    Bukkit.getOnlinePlayers().stream().forEach((p) -> {
                        NbtListener.rebuildInventoryContrnt(p);
