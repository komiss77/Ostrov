...
public class Ostrov extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        for (final Chanell ch : Chanell.values()) {
            ...
            getServer().getMessenger().registerOutgoingPluginChannel(this, ch.name);
            getServer().getMessenger().registerIncomingPluginChannel(this, ch.name, new SpigotChanellMsg());
        }
        ...
        Bukkit.getPluginManager().registerEvents(new ServerLst(), this);
        Bukkit.getPluginManager().registerEvents(new PlayerLst(), this);
        Bukkit.getPluginManager().registerEvents(new InteractLst(), this);
        Bukkit.getPluginManager().registerEvents(new TestLst(), this);
        Bukkit.getPluginManager().registerEvents(new GlobalBugFix(), this);

        if (Cfg.getConfig().getBoolean("system.use_armor_equip_event")) {
            Bukkit.getPluginManager().registerEvents(new ArmorEquipLst(), this);
        }
