...
public class BuilderMain implements InventoryProvider {
    ...
    public void init(final Player p, final InventoryContent content) {
        ...
        content.fillRect(0, 0, 4, 8, ClickableItem.empty(fill));
        ...
        if (Config.displays) {
            content.set(3, 6, ClickableItem.of(new ItemBuilder(Material.POPPED_CHORUS_FRUIT)
