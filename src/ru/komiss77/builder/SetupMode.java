...
//System.err.println("!!! ArmorStanddamage !"+e.getEntity().getCustomName()); 
    ...
    */
    ...
    public void onPlayerInteract(final PlayerInteractEvent e) {
        ...
        if (ItemUtils.compareItem(e.getItem(), BuilderCmd.openBuildMenu, (im1, im2) -> ItemUtils.compareName(im1, im2))) {
    ...
    public void onDrop(PlayerDropItemEvent e) {
        ...
        if (ItemUtils.compareItem(item, BuilderCmd.openBuildMenu, (im1, im2) -> ItemUtils.compareName(im1, im2))) {
            //e.setCancelled(true);
