...
public class Sedna implements InventoryProvider {
    ...
    public void init(final Player p, final InventoryContent content) {
      ...
      content.set(0, 0, ClickableItem.of(new ItemBuilder(Material.FIRE_CHARGE)
                ...
                .lore("")
                .lore("")
                .lore(Cfg.spawn_command ? "§7ЛКМ - переместиться" : "§cКоманда отключена")
                .lore("")
                .build(), e -> {
            p.closeInventory();
      ...
      content.set(0, 1, ClickableItem.of(new ItemBuilder(Material.ENDER_PEARL)
        ...
        /*if (Cfg.home_command) {
            content.set(1, 4, ClickableItem.of(new ItemBuilder(Material.LIME_BED)
                    ...
                    .lore("")
                    .lore("")
                    .lore(Cfg.home_command ? "§7ЛКМ - открыть" : "§cКоманда отключена")
                    .lore("")
                    .build(), e -> {
      ...
      content.set(0, 2, ClickableItem.of(new ItemBuilder(Material.PLAYER_HEAD)
                ...
                .lore("")
                .lore("")
                .lore(moderTPO ? "*право модератора" : Cfg.tpa_command_delay >= 0 ? "§7ЛКМ - отправить" : "§cКоманда отключена")
                .lore("")
                .build(), e -> {
      ...
      content.set(0, 3, ClickableItem.of(new ItemBuilder(Material.COMPASS)
                ...
                .lore("")
                .lore("")
                .lore(Cfg.tpr_command_delay >= 0 ? "§7ЛКМ - совершить" : "§cКоманда отключена")
                .lore("")
                .build(), e -> {
            p.closeInventory();
