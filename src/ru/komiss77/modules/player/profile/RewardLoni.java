...
public class RewardLoni {
    ...
    protected static void onStatAdd(final Player p, final Oplayer op, final Stat stat, final int ammount) {
        ...
        switch (stat) {
            ...
            case BW_win -> loniAdd = 10;

            case SN_game -> loniAdd = 5;
            case SN_win -> loniAdd = 5;
            case SN_gold -> loniAdd = ammount >> 2;

            case QU_game -> loniAdd = 5;
            case QU_kill -> loniAdd = 8;
            case QU_twin -> loniAdd = 10;
            case QU_win -> loniAdd = 10;

            case SG_game -> loniAdd = 10;
            case SG_kill -> loniAdd = 10;
            case SG_win -> loniAdd = 7;

            case HS_fw -> loniAdd = 3;
            case HS_game -> loniAdd = 7;
            case HS_win -> loniAdd = 10;
            case HS_hkill -> loniAdd = 20;
            case HS_skill -> loniAdd = 10;

            case TW_game -> loniAdd = 5;
            case TW_win -> loniAdd = 10;
            case TW_gold -> loniAdd = ammount >> 4;

            case BB_game -> loniAdd = 20;
            //case BB_win -> loniAdd = 10; - в customstat распределение по местам

            case CS_bomb -> loniAdd = 7;
            case CS_game -> loniAdd = 7;
            //case CS_hshot -> loniAdd = 3;
            case CS_kill -> loniAdd = 4;
            case CS_spnrs -> loniAdd = 4;
            case CS_win -> loniAdd = 4;

            case GR_game -> loniAdd = 5;
            case GR_kill -> loniAdd = 5;
            case GR_win -> loniAdd = 7;

            case KB_abil -> loniAdd = 3;
            case KB_cwin -> loniAdd = 7;
            case KB_kill -> loniAdd = 4;
            case KB_twin -> loniAdd = 7;
            ...
            case ZH_pdths -> loniAdd = 4;
            case ZH_win -> loniAdd = 4;
            case ZH_zklls -> loniAdd = 7;
            default -> loniAdd = 0;
        ...
        if (expAdd > 0) {
            ...
            op.addExp(p, NumUtil.randInt(1, loniAdd));
        }
    ...
    protected static void onCustomStat(final Player p, final Oplayer op, final String customStatName, final int ammount) {
        ...
        switch (customStatName) {
            ...
            case "Битва Строителей - 1 место" -> {
                loniAdd = 20;
                expAdd = NumUtil.randInt(20, 40);
            }
            case "Битва Строителей - 2 место" -> {
                loniAdd = 10;
                expAdd = NumUtil.randInt(15, 35);
            }
            case "Битва Строителей - 3 место" -> {
                loniAdd = 5;
                expAdd = NumUtil.randInt(10, 30);
            }
        }
