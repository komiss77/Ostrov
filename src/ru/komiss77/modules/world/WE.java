...
public class WE implements Initiable {
    ...
    /*@Deprecated //для регион гуи, без allign !!!
    public static void paste (final CommandSender cs, final Location pos1, final Schematic schem, final boolean pasteAir) {
        if (schem==null) {
        ...
        cuboid.setPos1(pos1);
//Ostrov.log(" ===  paste "+LocationUtil.StringFromLoc(pos1));
        final PasteJob job = new PasteJob(cs, pos1.getWorld(), cuboid, schem, Schematic.Rotate.r0, pasteAir); //вставка стартует с задержкой 1 тик
        JOBS.put(job.getId(), job);
        //return cuboid;
        //paste(cs, schem, pos1, Schematic.Rotate.r0, pasteAir);
    }   */ 
